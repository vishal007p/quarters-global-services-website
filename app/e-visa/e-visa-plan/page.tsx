...
const eVisaServices = [
    {
        ...
        description: "Travel with ease for vacations, family visits, and leisure.",
        link: "/e-visa/plan-section?type=Tourist&id=1",
    },
    {
        title: "Business E-Visa",
        description: "For international meetings, events, and business travel.",
        link: "/e-visa/plan-section?type=Business&id=2",
    },
    {
        title: "Medical E-Visa",
        description: "Get specialized treatment abroad with our assistance.",
        link: "/e-visa/plan-section?type=Medical&id=3",
    },
    {
        title: "Student E-Visa",
        description: "Hassle-free application for study programs worldwide.",
        link: "/e-visa/plan-section?type=Student&id=4",
    },
    {
        title: "Transit E-Visa",
        description: "Quick approvals for short layovers and connecting flights.",
