...
const savePlatformServiceStep = (stepData: any, createNew = false) => {
  if (typeof window === "undefined") return;
  const existing = localStorage.getItem("platformServices");
  const platformServices: any[] = existing ? JSON.parse(existing) : [];
...
const services = [
  {
    ...
    description:
      "Expedited Option offered via India Only. Super Urgent Appointment within 1–3 weeks.",
  ...
  },
  {
    ...
    description:
      "Exclusive Concierge service for India Only. Includes an appointment for US visa within 2–4 months.",
  ...
  },
  {
    ...
    description:
      "Have a pair of passport photos printed in our office, mailed to you, or provided digitally.",
    timeline: "Within 1–3 weeks",
    priceUSD: "$15.00",
    priceLocal: "₹1252.23",
  },
  ...
  },
  {
    ...
    description:
      "If your passport is lost, stolen, or damaged, we’ll replace the documents and provide assistance.",
    timeline: "-",
    priceUSD: "$40.00",
    priceLocal: "₹3445.95",
  },
...
const AdditionalServices = () => {
  ...
  const handleContinue = () => {
    ...
    savePlatformServiceStep({ selectedServices: selected });
