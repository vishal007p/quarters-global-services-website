                ...
                <div className="flex justify-center gap-24 w-full">
                    ...
                    <div className="flex flex-col items-center">
                        <svg width="61" height="60" viewBox="0 0 61 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M30.7031 23.1251C25.5255 23.1251 21.3281 27.3225 21.3281 32.5C21.3281 37.6778 25.5255 41.875 30.7031 41.875C35.8809 41.875 40.0781 37.6778 40.0781 32.5C40.0781 27.3225 35.8809 23.1251 30.7031 23.1251ZM25.0781 32.5C25.0781 29.3935 27.5966 26.875 30.7031 26.875C33.8096 26.875 36.3281 29.3935 36.3281 32.5C36.3281 35.6068 33.8096 38.125 30.7031 38.125C27.5966 38.125 25.0781 35.6068 25.0781 32.5Z" fill="#D31021" />
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M39.7309 3.95924C43.8726 3.36757 47.5781 6.58137 47.5781 10.7651V14.2063C50.5519 15.7782 52.5781 18.9025 52.5781 22.5V47.5C52.5781 52.6777 48.3809 56.875 43.2031 56.875H18.2031C13.0254 56.875 8.82812 52.6777 8.82812 47.5V12.5H8.83152C8.82927 12.4411 8.82812 12.3819 8.82812 12.3224C8.82812 10.0568 10.4941 8.13592 12.7369 7.81552L39.7309 3.95924ZM13.3808 16.8751L13.3592 16.875H12.5781V47.5C12.5781 50.6067 15.0965 53.125 18.2031 53.125H43.2031C46.3096 53.125 48.8281 50.6067 48.8281 47.5V22.5C48.8281 19.4014 46.3226 16.888 43.2271 16.8751H13.3808ZM43.8281 13.1251H43.2344L43.2031 13.125H13.3716C12.9325 13.1201 12.5781 12.7627 12.5781 12.3224C12.5781 11.923 12.8718 11.5843 13.2673 11.5278L40.2611 7.67154C42.1439 7.40259 43.8281 8.86342 43.8281 10.7651V13.1251Z" fill="#022146" />
                        </svg>
                    ...
                    <div className="flex flex-col items-center text-center">
                        <svg width="61" height="60" viewBox="0 0 61 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_762_3342)">
